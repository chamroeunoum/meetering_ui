/**
 * Khmer Date Plugin — Month/day name lookup in Khmer
 *
 * Installs global methods `$getKhMonth` and `$getKhDay` that translate
 * numeric month (1-12) and day (0-6) values to Khmer names.
 *
 * @module plugins/kh/date
 */
