/**
 * Vuex Position Module — Job position/title management (តួនាទី)
 *
 * CRUD operations for positions assigned to officers within organizations.
 *
 * @module store/modules/position
 */
