/**
 * Vuex User Module — User account management (អ្នកប្រើប្រាស់)
 *
 * Manages user accounts with support for:
 *   - Standard CRUD (list, read, update)
 *   - Identity verification (email/phone lookup)
 *   - Password management (change, forgot, reset)
 *   - Username/email/phone uniqueness checks
 *   - Signup confirmation and activation
 *   - Dashboard user totals
 *
