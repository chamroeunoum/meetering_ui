/**
 * Vuex MeetingOrganization Module — Meeting source organization CRUD (ប្រភពកិច្ចប្រជុំ)
 *
 * Manages organizations that can be meeting sources.
 *
 * @module store/modules/meeting/organization
 */
