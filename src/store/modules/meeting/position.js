/**
 * Vuex MeetingPosition Module — Meeting position/title CRUD (តួនាទី)
 *
 * Manages position/title assignments for meeting participants.
 *
 * @module store/modules/meeting/position
 */
