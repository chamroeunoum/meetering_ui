/**
 * Vuex MeetingType Module — Meeting type classification CRUD (ប្រភេទកិច្ចប្រជុំ)
 *
 * Manages meeting type categories with full CRUD and file upload support.
 *
 * @module store/modules/meeting/type
 */
...
const mutations = {
  ...
  setPaginationEnd( state , end ){
    ...
    state.pagination.end = parseInt( end ) // UPDATED: was referencing undefined 'stendart'
  },
