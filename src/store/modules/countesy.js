/**
 * Vuex Countesy Module — Honorific/title management (ងារ)
 *
 * CRUD operations for courtesy titles assigned to officers (e.g., ឯកឧត្តម, លោកជំទាវ).
 *
 * @module store/modules/countesy
 */
