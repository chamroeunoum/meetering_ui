/**
 * Vuex Search Regulators Module — Regulatory document search (ស្វែងរកលិខិតបទដ្ឋាន)
 *
 * Advanced search for regulatory documents with multi-criteria filtering:
 * folder, year, types, signatures, organizations. Also supports compact
 * list views and type aggregations.
 *
 * @module store/modules/search_regulators
 */
