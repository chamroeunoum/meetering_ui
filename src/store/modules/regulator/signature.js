/**
 * Vuex RegulatorSignature Module — Regulator signature CRUD (ហត្ថលេខា)
 *
 * Manages signatures associated with regulatory documents.
 *
 * @module store/modules/regulator/signature
 */
