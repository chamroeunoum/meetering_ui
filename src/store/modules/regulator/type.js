/**
 * Vuex RegulatorType Module — Regulator document type CRUD (ប្រភេទលិខិតបទដ្ឋាន)
 *
 * Manages regulator document type categories with list, compact, and full CRUD.
 *
 * @module store/modules/regulator/type
 */
