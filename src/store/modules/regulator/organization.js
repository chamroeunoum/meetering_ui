/**
 * Vuex RegulatorOrganization Module — Regulator organization CRUD (អង្គភាពលិខិតបទដ្ឋាន)
 *
 * Manages organizations that issue regulatory documents.
 *
 * @module store/modules/regulator/organization
 */
